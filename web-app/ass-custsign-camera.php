...
$page_title = "Customer Signature Verification";
$page_link = "";
                    ...
                    <div class="card card-outline card-brand">
                        <div class="card-body min-high2">
                            <div class="row justify-content-center">
                                <form id="app-custsign-cam" name="app-custsign-cam" class="form-material">
                                   ...
                                   <input type="hidden" name="token" value="<?php echo (isset($_SESSION['APP_TOKEN'])) ? $_SESSION['APP_TOKEN'] : ""; ?>"/>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12 text-center h5">Take Signature photo</div>
                                        </div>
...
<script type="text/javascript">
    ...
    function gobackbut(ass_ref_num) {
        goto_url('ass-form-camera?ref_Num='+ass_ref_num);
    }
    ...
    function upload_livePhoto(file_id,file_mode) {
        ...
        formData.append('cmd','ass_custsign_camera');
        formData.append('asnVal',$('#asnVal').val()); //ref no
        formData.append('FILE_MODE',file_mode); //mode- live photo , gpc
       formData.append('UPLOAD_FILE',blob,'custsign.jpeg'); //file data
