...
$page_title = "Branch Camera Verification";
$page_link = "";
                    ...
                    <div class="card card-outline card-brand">
                        <div class="card-body min-high2">
                            <div class="row justify-content-center">
                                <form id="app-service-rekyc-cam" name="app-service-rekyc-cam" class="form-material">
                                    ...
                                    <input type="hidden" id="STAFF_GEO_LAT" name="STAFF_GEO_LAT">
                                    <input type="hidden" id="STAFF_GEO_LONG" name="STAFF_GEO_LONG">
                                    <div class="row justify-content-center">

                                        <div class="col-md-6 col-lg-7 my-2">

                                        <div class="row mt-3">
                                            <div class="col-md-12 text-center h5">Take Branch User Photo</div>
                                        </div>
...
<script type="text/javascript">
    ...
    function upload_livePhoto(file_id,file_mode) {
       ...
       // var FILE_UPLD_FLAG = $('#FILE_UPLD_FLAG').val();
        ...
        formData.append('cmd','ass_branch_camera');
        ...
        formData.append('UPLOAD_FILE',blob,'branch.jpeg'); //file data
        formData.append('STAFF_GEO_LAT',$('#STAFF_GEO_LAT').val()); //ref no
        formData.append('STAFF_GEO_LONG',$('#STAFF_GEO_LONG').val()); //ref no
        ...
        if (navigator.geolocation) {
           // loader_start();
            navigator.geolocation.getCurrentPosition(function(position) {
                $('#STAFF_GEO_LAT').val(btoa(position.coords.latitude));
                $('#STAFF_GEO_LONG').val(btoa(position.coords.longitude));
            ...
            function(error) {
                if (error.code == error.PERMISSION_DENIED) {
                   ...
                   //enable('nextBtn');
                   // loader_stop();
                   swal.fire('', 'Geolocation is not supported');
                }
            });
        } else {
            swal.fire('', 'Geolocation is not supported');
