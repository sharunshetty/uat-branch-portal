                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    <tbody>
                                       ...
                                       // echo isset($item_data["ASSREQ_CUST_DOB"]) ? date('d-m-Y', strtotime($item_data['ASSREQ_CUST_DOB'])) : "-NA-";
                                        ...
                                        echo $item_data2['ASSREQ_OCCUPATION_CODE'];
                                        // echo isset($item_data2['ASSREQ_OCCUPATION_CODE']) ? $main_app->getval_field('occupations@cbsdblink', 'OCCUPATIONS_DESCN', 'OCCUPATIONS_CODE', $item_data2['ASSREQ_OCCUPATION_CODE']) : "-NA-";
                                        echo '</td></tr>';
